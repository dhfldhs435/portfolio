...
<body>
	<h1 style="position: static; right: 50%;">판매자 공지사항</h1>
	...
	<table class="member">
		<tr>
			<th align="center" width="180">공지사항 일련번호</th>
			<th align="center" width="150">제목</th>
			<th align="center" width="180">날짜</th>
	...
	<div class="pagination">
		<ul>
			<c:if test="${pageMaker.prev }">
				<li><a
					href="sellerNoticeList${pageMaker.makeSearch(pageMaker.startPage - 1)}">이전</a></li>
			</c:if>
			...
			<c:if test="${pageMaker.next && pageMaker.endPage > 0 }">
				<li><a
					href="sellerNoticeList${pageMaker.makeSearch(pageMaker.endPage + 1)}">다음</a></li>
			</c:if>
