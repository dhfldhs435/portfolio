...
<form:form modelAttribute="notice" action="memberModify"
	...
	<table border="1" class="member">
		...
		<tr>
			...
			<td colspan="3"><form:input path="mn_title" size="150"/></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="3"><input type="file" name="mn_attachment" /></td>
		</tr>
	</table>
</form:form>
...
<script>
	$(document).ready(function() {
		...
		$("#btnList").on("click", function() {
			self.location = "/admin/notice/memberList${pgrq.toUriString()}";
		});
	});
</script>