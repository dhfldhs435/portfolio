...
public class PageRequest {
	...
	public String toUriString() {
		UriComponents uriComponent = UriComponentsBuilder.newInstance().queryParam("page", this.page)
	...
	public String toUriString(int page) {
		UriComponents uriComponent = UriComponentsBuilder.newInstance().queryParam("page", page)
